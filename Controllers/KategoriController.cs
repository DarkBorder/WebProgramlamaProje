...
namespace AnimeBox.Controllers
{
    public class KategoriController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AnimeTuru")] Kategori kategori)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AnimeTuru")] Kategori kategori)
        {
            if (id != kategori.Id)
            {
                return NotFound();
