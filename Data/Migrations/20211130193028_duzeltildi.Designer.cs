...
namespace AnimeBox.Data.Migrations
{
    ...
    [Migration("20211130193028_duzeltildi")]
    partial class duzeltildi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimeBox.Models.AnimeOnemliKarakterler", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("OnemliKarakterlerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OnemliKarakterlerId");

                    b.ToTable("AnimeOnemliKarakterler");
                });

            modelBuilder.Entity("AnimeBox.Models.AnimeStudyo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AnimeBox.Models.OnemliKarakterler", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("KarakterinAdi")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("OnemliKarakterler");
                });
            ...
            modelBuilder.Entity("AnimeBox.Models.AnimeOnemliKarakterler", b =>
                {
                    ...
                    b.HasOne("AnimeBox.Models.OnemliKarakterler", "OnemliKarakterler")
                        .WithMany()
                        .HasForeignKey("OnemliKarakterlerId");
                });
